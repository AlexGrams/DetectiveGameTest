...
#include "DetectiveGameTestCharacter.generated.h"
...
UCLASS(config=Game)
class ADetectiveGameTestCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	/**
	 * Overridden default pawn rotation control to allow locking rotation.
...
public:
	...
	//USkeletalMeshComponent* GetMesh1P() const { return NULL; }
